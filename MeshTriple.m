function [p_new,t_new,I,B] = MeshTriple(param)

H=param.H; h=param.h; L=param.L; H1=param.L2; H2=param.L1; 
...
v1 = [0,-H; 0,H1; L,H1; L,-H];  
g1 = [3;4;v1(:,1);v1(:,2)]; % [3,4,x1,x2,x3,x4,y1,y2,y3,y4]'
v2 = [0,H1; 0,H2; L,H2; L,H1]; 
g2 = [3;4;v2(:,1);v2(:,2)]; % [3,4,x1,x2,x3,x4,y1,y2,y3,y4]'
v3 = [0,H2; 0,H; L,H; L,H2]; 
g3 = [3;4;v3(:,1);v3(:,2)]; % [3,4,x1,x2,x3,x4,y1,y2,y3,y4]'

geom_matrix = [g1 g2 g3];
set_formula = 'g1+g2+g3';    

% Add the geometry to the PDE model
geometryFromEdges(model, decsg(geom_matrix, set_formula, char('g1', 'g2', 'g3')'));
